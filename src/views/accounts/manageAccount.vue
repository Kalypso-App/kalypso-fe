                        ...
                        <v-expansion-panel >
                           ...
                           <v-expansion-panel-content>
                              ...
                              <div class="pricing-container">
                                 <div @click="onchangepricing(product)"
                                 v-for="(product, i) in products"
                                    :key="i"
                                    :class="product.selected ? 'selected' : ''"
                                    class="pricing-v2-card">
...
import { basic_key } from "../../config";
import { pro_key } from "../../config";
import Vue from 'vue';
  ...
  methods:{
   async getProducts(){
    ...
    if (this.$refs.profileform.validate()) {
        ...
        let response = await this.$http.post(`/update-user`, {
