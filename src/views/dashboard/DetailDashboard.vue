<template>
  <div class="campaign-detail">
    <div
      class="brand-info pl-8 pt-8 d-inline-flex justify-space-between align-center"
    >
      <div class="d-flex align-center">
        <v-img
          class="brand-info-logo"
          :src="campaign.brand_logo ? campaign.brand_logo : logo"
        ></v-img>
    ...
    <div>
      <div class="row px-8">
        <div class="text-center col-md-3 col-12">
          <v-card class="overall performance width">
            <div class="stat-title">
              <h4 style="color:#4C6072" class="overalltitle">
                Campaign Performance
              </h4>
              <v-tooltip class="my-tooltip" right>
                <template v-slot:activator="{ on }">
                  <v-icon class="data-tooltip" v-on="on"
                    >mdi-chat-processing-outline</v-icon
                  >
                </template>
                <span class="tooltip-span"
                  >Your campaign's overall performance</span
                >
              </v-tooltip>
            </div>
            <div class="stat-symbol mt-3">
              ...
              <img
                class="widthimg"
                height="75"
                src="@/assets/images/campaign_graph.png"
                alt
              />

              <v-icon
                class="overall-gauge"
                :style="{ transform: getOverAllPerformance(true) }"
                >mdi-sign-pole</v-icon
              >
        ...
        <div
          v-if="isIgAndYt() && !isOnlyBlogs()"
          class="text-center col-md-3 col-12"
        >
          <v-card class="overall width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >Total number of campaign impressions</span
                >
              </v-tooltip>
            </div>
          ...
          <v-card class="overall width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >Based on initial performance, estimated projection of video
          ...
          <v-card class="overall width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >How much of your video was watched on average.</span
                >
              </v-tooltip>
            </div>
            <div class="stat-detail">
          ...
          <v-card class="overall width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >Using an industry standard CPM comparison, industry standard
          ...
          <v-card class="overall performance width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >Cost per thousand impressions. Industry standard metric for
                  social</span
                >
              </v-tooltip>
            </div>
          ...
          <v-card class="overall performance width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >How much each impression cost based on campaign budget</span
                >
              </v-tooltip>
            </div>
            <div class="stat-detail">
          ...
          <v-card class="overall performance width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >How much each engagement cost based on campaign budget</span
                >
              </v-tooltip>
            </div>
            <div class="stat-detail">
          ...
          <v-card class="overall performance width">
            <div class="stat-title">
              ...
              <v-tooltip class="my-tooltip" right>
                ...
                <span class="tooltip-span"
                  >How much each pageview cost based on campaign budget</span
                >
              </v-tooltip>
            </div>
            <div class="stat-detail">
    ...
    <div class="instagram-profile" v-if="campaignIgDetail">
      <div
        class="instagram-info pl-8 pt-8 d-inline-flex justify-space-between align-center"
      >
        <div class="d-flex align-center">
          <v-img
            class="instagram-info-logo"
            :src="campaignIgDetail.profile_picture_url"
          ></v-img>
          <v-img
    ...
    <div v-if="campaign.posts && campaign.posts.length">
        ...
        <div class="row">
          <div class="text-center col-md-3 col-12">
            <v-card class="stats impression width height">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="instafeeddata">Impressions</h6>
          ...
          <div class="text-center col-md-3 col-12">
            <v-card class="stats reach width height">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="instafeeddata">Reach</h6>
          ...
          <div class="text-center col-md-3 col-12">
            <v-card class="stats frequncy width height">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="instafeeddata">Frequency</h6>
          ...
          <div class="text-center col-md-3 col-12">
            <v-card class="stats audience width height">
              <div class="stat-data text-left">
                <h6 class="instafeeddata mr-12 mt-3">Audience Viewability</h6>
              </div>
              <div class="progress-bar">
                <div
                  :style="{ width: getIgFeedAudience() + '%' }"
        ...
        <div class="row">
          <div class="text-center col-md-4 col-12">
            <v-card class="stats engagement-rate width height">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="instafeeddata">Follower Engagement Rate</h6>
          ...
          <div class="text-center col-md-4 col-12">
            <v-card class="stats engagement-rate width height">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="instafeeddata">Post Engagement Rate</h6>
          ...
          <div class="text-center col-md-4 col-12">
            <v-card class="stats comments width height">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="instafeeddata">Comments</h6>
          ...
          <div class="text-center col-md-4 col-12">
            <v-card class="stats saves width height">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="instafeeddata">Save Rate</h6>
      ...
      <div class="row py-20 pl-8">
        <div
          ...
          v-bind:key="i"
          v-for="(post, i) in campaign.posts"
          v-loading="dashboardLoading"
        >
          <v-card class="instagram-content" width="100%">
            <div>
              <img
                class="instagram-light"
                src="@/assets/images/instagram-light.png"
              />
            </div>
            ...
            <div class="instagram-content-stats">
              ...
              <div class="my-col-6">
                <span class="pull-right">{{
                  post.post_detail.comments_count || 0
                }}</span>
              </div>
            </div>
            <div class="instagram-content-stats">
              ...
              <div class="my-col-6">
                <span class="pull-right youtube">{{ getIgPostSaves(post) }}</span>
              </div>
            </div>
            <!--
                    <div class="instagram-content-stats">
    ...
    <div v-if="campaign.stories && campaign.stories.length">
        ...
        <div class="row">
          ...
          <div class="text-center col-md-3 col-12">
            <v-card class="stats audience width height">
              ...
              <div class="progress-bar">
                <div
                  :style="{ width: getIgStoryAudience() + '%' }"
                  class="progress-bar-completed"
                ></div>
              </div>
              <!--<v-tooltip class="my-tooltip" right>
      ...
      <div class="engagement px-8">
        ...
        <div class="custom">
          ...
          >
            ...
            <div class="progress-bar">
              <div
                :style="{ width: getIgStoryRetention() + '%' }"
                class="progress-bar-completed"
              ></div>
            </div>
      ...
      <div class="row py-20 pl-8">
        <div
          class="col-md-4 col-12"
          v-bind:key="i"
          v-for="(story, i) in campaign.stories"
          v-loading="dashboardLoading"
        >
          <v-card class="instagram-content" width="95%">
            <div>
              <img
                class="instagram-light mt-5"
                src="@/assets/images/instagram-light.png"
              />
            </div>
            <div class="instagram-content-image">
              <video
                ...
                v-if="
                  story.post_detail &&
                    ...
                    isVideo(story.post_detail.media_url)
                "
                align="center"
                justify="center"
              >
            ...
            <div class="instagram-content-stats">
              ...
              <div class="my-col-6">
                <span class="pull-right youtubeabc">{{ getIgStoryReplies(story) }}</span>
              </div>
            </div>
            <div class="instagram-content-stats">
              <div class="my-col-6">
              ...
              <div class="my-col-6">
                <span class="pull-right youtubeabc">{{ getIgStoryTapBacks(story) }}</span>
              </div>
            </div>
          </v-card>
        </div>
    ...
    <div v-if="campaign.yt_videos && campaign.yt_videos.length">
        ...
        <div class="row">
          <div class="text-center col-md-3 col-12">
            <v-card class="stats impression width heightyoutube">
              ...
              <div class="stat-data position  text-left">
                <h6 class="textview">Video Views</h6>
                <h3 class="textno">{{ getYtTotalViews() }}</h3>
              </div>
              <div>
                <img
                  style="height: 54px;width: 41px;"
                  src="@/assets/images/ig_awareness_imression.png"
                  alt
                />
                <!-- <v-tooltip class="my-tooltip" right>
                                <template v-slot:activator="{ on }">
          ...
          <div class="text-center col-md-3 col-12">
            <v-card class="stats frequncy width heightyoutube">
              ...
              <div class="stat-data position mt-6 text-left">
                <h6 class="textview">Avg View Duration</h6>
                <h3 class="textno">{{ getYtAvgDuration() }}</h3>
              </div>
              <div>
                <img
                  style="height: 54px;width: 41px; margin-top: 23px;"
                  src="@/assets/images/frequncy_green.png"
                  alt
                />
                <!-- <v-tooltip class="my-tooltip" right>
                                <template v-slot:activator="{ on }">
          ...
          <div class="text-center col-md-3 col-12">
            <v-card class="stats audience width height">
              <div class="stat-data text-left">
                <h6 class="textview Audience">Audience Viewability</h6>
              </div>
              <div class="progress-bar">
                <div
                  :style="{ width: getYtAudience() + '%' }"
                  class="progress-bar-completed"
                ></div>
              </div>
              <!-- <v-tooltip class="my-tooltip" right>
          ...
          <div class="text-center col-md-3 col-12">
            <v-card class="stats audience width height">
              <div class="stat-data text-left">
                <h6 class="textview completion">100% Completion Rate</h6>
              </div>
              <div class="progress-bar">
                <div
                  :style="{ width: getYtCompletion() + '%' }"
                  class="progress-bar-completed"
                ></div>
              </div>
              <!-- <v-tooltip class="my-tooltip" right>
              ...
              <h3 class="textno completerate">{{ getYtCompletion() }}%</h3>
            </v-card>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <v-select               
                      ...
                      color="#FAFCFE"
                      v-model="ytChartSelected"
                      :items="ytChartItems"
                      @input="ytChartChanged"
                    ></v-select>
                  </div>
                </div>
                <div class="row text-left ml-4">
                  <div class="stat-data col-md-3">
                    <h6 class="totalview">Views</h6>
                    <h3 class="totalviewnewcount">{{ getYtTotalViews() }}</h3>
                  </div>
                  <div class="stat-data col-md-3">
                    <h6 class="totalview">Engagement</h6>
                    <h3 class="totalviewnewcount">
                      {{ getYtTotalEngagement() }}%
                    </h3>
                  </div>
                  <div class="stat-data col-md-3">
                    <h6 class="totalview">CPM</h6>
                    <h3 class="totalviewnewcount">${{ getYtTotalCPM() }}</h3>
                  </div>
                </div>
              </div>
              <line-chart              
          ...
          <div class="text-center col-md-3 col-12">
            ...
            <v-card class="stats comments yt-column width">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="textview">Likes</h6>
                <h3 class="textno">{{ getYtLikes() }}</h3>
              </div>
              <div>
                <!-- <v-tooltip class="my-tooltip" right>
                                <template v-slot:activator="{ on }">
            ...
            <v-card class="stats reach yt-column width ">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="textview">Comments</h6>
                <h3 class="textno">{{ getYtComments() }}</h3>
              </div>
              <div>
                <!--<v-tooltip class="my-tooltip" right>
                                <template v-slot:activator="{ on }">
            ...
            <v-card class="stats impression yt-column width">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="textview">Shares</h6>
                <h3 class="textno">{{ getYtShares() }}</h3>
              </div>
              <div>
                <img src="@/assets/images/ig_awareness_imression.png" alt />
                <!-- <v-tooltip class="my-tooltip" right>
            ...
            <v-card class="stats engagement-rate  yt-column width">
              ...
              <div class="stat-data text-left ml-2">
                <h6 class="textview">Card Click</h6>
      ...
      <div class="row py-20 pl-8">
        <div
          class="col-md-4 col-12"
          v-bind:key="i"
          v-for="(video, i) in campaign.yt_videos"
          v-loading="dashboardLoading"
        >
          <v-card class="instagram-content" width="95%" min-height="506">
            ...
            <div class="instagram-content-stats">
              ...
              <div class="my-col-6">
                <span class="pull-right youtubeabc">{{ getYtVideoViews(video) }}</span>
              </div>
            </div>
            <div class="instagram-content-stats">
              <div class="my-col-6">
              ...
              <div class="my-col-6">
                <span class="pull-right youtubeabc">{{ getYtVideoLikes(video) }}</span>
              </div>
            </div>
            <div class="instagram-content-stats">
              <div class="my-col-6">
              ...
              <div class="my-col-6">
                <span class="pull-right youtubeabc">{{ getYtVideoShares(video) }}</span>
              </div>
            </div>
            </div>
          </v-card>
    ...
    <div class="instagram-profile" v-if="campaignBlogDetail">
      ...
      >
        <div class="d-flex align-center">
          <v-img
            class="instagram-info-logo"
            :src="campaignBlogDetail.picture"
          ></v-img>
          <v-img
            class="instagram-logo"
    ...
    <div v-if="campaign.blog_pages && campaign.blog_pages.length">
            ...
            <v-card class="stats impression">
              ...
              <div>
                ...
                <v-tooltip class="my-tooltip" right>
                  ...
                  <span class="tooltip-span"
                    >Total number of views on a blog post.</span
                  >
                </v-tooltip>
              </div>
            </v-card>
            ...
            <v-card class="stats frequncy">
              ...
              <div>
                ...
                <v-tooltip class="my-tooltip" right>
                  ...
                  <span class="tooltip-span"
                    >Time spent on blog post page.</span
                  >
                </v-tooltip>
              </div>
            </v-card>
            ...
            <v-card class="stats reach">
              ...
              <div>
                <v-tooltip class="my-tooltip" right>
                  ...
                  <span class="tooltip-span"
                    >Number of monthly individual users visiting the blog.</span
                  >
                </v-tooltip>
                <img src="@/assets/images/ig_awareness_reach.png" alt />
              </div>
            ...
            <v-card class="stats frequncy">
              ...
              <div>
                ...
                <v-tooltip class="my-tooltip" right>
                  ...
                  <span class="tooltip-span"
                    >Traffic volume from organic Google search.</span
                  >
                </v-tooltip>
              </div>
            </v-card>
            ...
            <v-card class="chart stats audience">
              <div style="width: 100%">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <v-select
                      v-model="ytChartSelectedBlog"
                      :items="ytChartBlogsItems"
                      @input="ytChartBlogChanged"
                    ></v-select>
                  </div>
                </div>
                <div class="row">
              ...
              <line-chart
                class="chart"
                id="bar-chart-blog"
                :label="ytChartSelectedBlog"
                :data="datacollectionBlog"
              ></line-chart>
            </v-card>
          </div>
          <div class="text-center col-md-3 col-12">
            <v-card class="stats reach yt-column">
              ...
              <div>
                <v-tooltip class="my-tooltip" right>
                  ...
                  <span class="tooltip-span"
                    >Total number of likes, comments, shares the video received
      ...
      <div class="row py-20 pl-8">
        <div
          class="col-md-4 col-12"
          v-bind:key="i"
          v-for="(blog, i) in campaign.blog_pages"
          v-loading="dashboardLoading"
        >
          <v-card class="instagram-content" width="90%">
            ...
            <div class="instagram-content-image">
              <img
                v-if="blog.ogImage && blog.ogImage.url"
  ...
  methods: {
      ...
      if (this.isOnlyBlogs()) {
        ...
        if (isNotOnlyYouTube) {
          if (this.campaignIgDetail) {
            ...
            er =
              (likes + comments + replies + tapbacks + saves) / totalImpression;
            wer =
              (likes * 0.5 +
                comments * 3 +
                tapbacks * 3 +
            ...
            if (totalImpression) {
              ...
              if (!campaignYtDetail) {
                if (followers_count < 9999) {
                  ...
                  percent =
                    (0.33 *
                      ((likes + comments + replies + tapbacks + saves) /
                        followers_count /
                        0.02) +
                      0.33 * (wer / 0.04) +
                      0.33 * (48 / cpm)) *
                ...
                percent =
                  (0.5 *
                    ((likesYT * 1 + commentsYT * 3 + sharesYT * 5) / viewsYT)) /
                    0.03 +
                  0.5 * (avpYT / 0.6) +
                  ((0.33 *
                    ((likes + comments + replies + tapbacks + saves) /
                    ...
                    (0.33 *
                      ...
                      0.33 *
                        (48 /
                          ((this.campaign.amount / totalImpression) * 1000)))) *
                    100) /
                    2;
          ...
          if (this.campaignYtDetail) {
            ...
            if (followers_count < 9999) {
              ...
              percent =
                (0.5 * ((likes * 1 + comments * 3 + shares * 5) / views)) /
                  0.04 +
                0.5 * ((avgViewPercentage / 100) * 0.6);
    ...
    isIgAndYt() {
      if (this.campaign) {
        if (
          this.campaign.posts &&
          this.campaign.posts.length == 0 &&
          this.campaign.stories &&
          this.campaign.stories.length == 0 &&
          this.campaign.yt_videos &&
          this.campaign.yt_videos.length > 0
        ) {
          return false;
        }
      }
    ...
    getOverallEngagement() {
      ...
      if (isNotOnlyYouTube) {
        if (this.campaign && this.campaignIgDetail) {
          ...
          if (totalImpression) {
            return (
              ((likes + comments + saves + replies + tapbacks) /
                totalImpression) *
              100
            ).toFixed(2);
          }
    ...
    getIgStoryRetention() {
      if (this.campaign.stories && this.campaign.stories.length) {
        ...
        if (first.insights && last.insights) {
          return (
            (last.insights.impressions / first.insights.impressions) *
            100
          ).toFixed(2);
        }
      }
    ...
    getYtVideoShares(video) {
      ...
      if (video.analytics && video.analytics.columnHeaders) {
        let avgAtIndex = video.analytics.columnHeaders.findIndex(
          (x) => x.name == "shares"
        );
        if (avgAtIndex != -1) {
    ...
    getYtAudience() {
      if (
        ...
        this.campaign.yt_videos[0].account_detail
      ) {
        let totalViews = this.getYtTotalViews();
        let subscriber = parseInt(
          this.campaign.yt_videos[0].account_detail.subscriberCount
        );
    ...
    getYtAvgCompletion() {
      if (this.campaign.yt_videos && this.campaign.yt_videos.length) {
        ...
        this.campaign.yt_videos.forEach((video) => {
          if (video.analytics && video.analytics.columnHeaders) {
            let avgAtIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "averageViewPercentage"
            );
            let viewAtIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "views"
            );
    ...
    getYtCardClick() {
      if (this.campaign.yt_videos && this.campaign.yt_videos.length) {
        ...
        this.campaign.yt_videos.forEach((video) => {
          if (video.analytics && video.analytics.columnHeaders) {
            let cardAtIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "cardClickRate"
            );
            if (cardAtIndex != -1) {
              video.analytics.rows.forEach((row) => {
    ...
    getYtProjectedViews() {
      ...
      if (this.campaign.yt_videos && this.campaign.yt_videos.length) {
        ...
        this.campaign.yt_videos.forEach((video) => {
          if (video.analytics && video.analytics.columnHeaders) {
            let dateAtIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "day"
            );
            let viewAtIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "views"
            ...
            if (viewAtIndex != -1) {
              ...
              let projectedRecords = me.findProjection(
                length,
                start,
                end,
                dateAtIndex,
      ...
      if (this.campaign.blog_pages && this.campaign.blog_pages.length) {
        ...
        this.campaign.blog_pages.forEach((blog) => {
          if (blog.insight_detail && blog.insight_detail.columnHeaders) {
            views += parseInt(
              blog.insight_detail.totalsForAllResults["ga:pageviews"]
            );
    ...
    getBlogsAvgTime() {
      if (this.campaign.blog_pages && this.campaign.blog_pages.length) {
        ...
        this.campaign.blog_pages.forEach((blog) => {
          if (blog.insight_detail && blog.insight_detail.columnHeaders) {
            time += parseInt(
              blog.insight_detail.totalsForAllResults["ga:avgTimeOnPage"]
            );
    ...
    getBlogsUniqueUsers() {
      if (this.campaign.blog_pages && this.campaign.blog_pages.length) {
        ...
        this.campaign.blog_pages.forEach((blog) => {
          if (blog.insight_detail && blog.insight_detail.columnHeaders) {
            users += parseInt(
              blog.insight_detail.totalsForAllResults["ga:newUsers"]
            );
    ...
    getBlogsOrganicSearch() {
      if (this.campaign.blog_pages && this.campaign.blog_pages.length) {
        ...
        this.campaign.blog_pages.forEach((blog) => {
          if (blog.insight_detail && blog.insight_detail.columnHeaders) {
            users += parseInt(
              blog.insight_detail.totalsForAllResults["ga:organicSearches"]
            );
    ...
    getBlogsPagesPerSession() {
      if (this.campaign.blog_pages && this.campaign.blog_pages.length) {
        ...
        this.campaign.blog_pages.forEach((blog) => {
          if (blog.insight_detail && blog.insight_detail.columnHeaders) {
            let viewAtIndex = blog.insight_detail.columnHeaders.findIndex(
              (x) => x.name == "ga:ga:sessions"
            );
            if (viewAtIndex != -1) {
              blog.insight_detail.rows.forEach((row) => {
                if (parseInt(row[viewAtIndex])) {
    ...
    getBlogsTimeOnPage(blog) {
      if (blog && blog.insight_detail) {
        return this.fancyTimeFormat(
          blog.insight_detail.totalsForAllResults["ga:timeOnPage"]
        );
      }
      return 0;
    },
      ...
      if (this.campaign.yt_videos.length) {
        this.campaign.yt_videos.forEach((video, index) => {
          if (video && video.analytics) {
            let dayIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "day"
            );
            let viewIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "views"
            );
            let dateAtIndex = video.analytics.columnHeaders.findIndex(
              (x) => x.name == "day"
            ...
            if (dayIndex != -1) {
              ...
              video.analytics.rows.forEach((row) => {
                ...
                me.datacollection.datasets[index].data.push(
                  me.getChartYAxesData(video.analytics.columnHeaders, row)
                );
    ...
    getChartYAxesData(headers, row) {
      if (this.ytChartSelected == "CPM") {
        ...
        if (row[viewIndex]) {
          return (
            ((row[likeIndex] + row[commentIndex] + row[shareIndex]) /
              row[viewIndex]) *
            100
          ).toFixed(2);
        }
    ...
    campaignYtChartBlogs() {
      ...
      if (this.campaign.blog_pages.length) {
        this.campaign.blog_pages.forEach((blog, index) => {
          if (blog && blog.insight_detail) {
            let dayIndex = blog.insight_detail.columnHeaders.findIndex(
              (x) => x.name == "ga:date"
            );
            let viewIndex = blog.insight_detail.columnHeaders.findIndex(
              (x) => x.name == "ga:pageviews"
            );
            ...
            if (dayIndex != -1) {
              ...
              let projectedRecords = me.findProjectionBlog(
                length,
                start,
                end,
                dayIndex,
                blog.insight_detail.rows
              );
              ...
              blog.insight_detail.rows.forEach((row) => {
                ...
                let lbl = me.getChartDateShort(row[dayIndex]);
                if (
                  me.datacollectionBlog.labels.findIndex((x) => x == lbl) == -1
                ) {
                  me.datacollectionBlog.labels.push(lbl);
                }
                me.datacollectionBlog.datasets[index].data.push(
                  me.getChartYAxesDataBlog(
                    blog.insight_detail.columnHeaders,
                    row
                  )
                );
                me.datacollectionBlog.datasets[index].label =
                  blog.insights["ga:pageTitle"];
              });
            }
          }
        });
    ...
    getChartYAxesDataBlog(headers, row) {
      if (this.ytChartSelectedBlog == "Page Views") {
        ...
        let viewIndex = headers.findIndex(
          (x) => x.name == "ga:organicSearches"
        );
        return row[viewIndex];
      }
    },
